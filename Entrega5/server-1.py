                ...
                if x == 1:
                    while fline != cnt:
                        ...
                        if fline.find(search) == 0:
                        	...
                        	f.seek(position-len(fline)+len(search),0)
            ...
            if 'GET /home.html' in line:
                ...
                while fline != '</html>':
                    ...
                    if fline.find('Act1:') == 0:
                        ...
                        f.write(' ON')
                        print 'Recibido mensaje: Act1 pasa a estado ON'
                        position = f.tell()
                        break
                ...
                while fline != '</html>':
                    ...
                    if fline.find('Act1:') == 0:
                        f.seek(position+len('Act1: '),0)
                        f.write('OFF')
                        print 'Recibido mensaje: Act1 pasa a estado OFF'
                        position = f.tell()
                        break
                ...
                while fline != '</html>':
                    ...
                    if fline.find('Act2:') == 0:
                        ...
                        f.write(' ON')
                        print 'Recibido mensaje: Act2 pasa a estado ON'
                        position = f.tell()
                        break
                ...
                while fline != '</html>':
                    ...
                    if fline.find('Act2:') == 0:
                        f.seek(position+len('Act2: '),0)
                        f.write('OFF')
                        print 'Recibido mensaje: Act2 pasa a estado OFF'
                        position = f.tell()
                        break
